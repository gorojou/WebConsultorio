...
var TwilioVideo = function (options) {
    ...
    /**
     * /funcion to get videochattoken and send fcm to phone (is video or not
     * @param {any} isVideo
     */
    function notificatePatientPromise(isVideo) {
        return $.ajax({
    ...
    function initCallPromise() {
        ...
        return $.ajax({
            ...
            error: function (xhr, ajaxOptions, thrownError) {
                console.log("initCallPromise(): " + xhr.status);
                console.log("initCallPromise(): " + thrownError);
            }
        });
    }
    ...
    document.getElementById(options.btnJoinCallId).onclick = function (ev) {
        ...
        initCallPromise().
            then((data) => {
                notificatePatientPromise(false)
                    .then(() => {
                        var connectOptions = {
